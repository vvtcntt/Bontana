    ...
    public class productController : Controller
    {
        ...
        public ActionResult productTag(string tag)
        {
            ...
            if (listProduct.Count > 0)
            {
                ...
                ViewBag.canonical = "<link rel=\"canonical\" href=\"http://Bontana.vn/tag/" + tag + "\" />";
                result.Append("<div class=\"tearListProduct\">");
                result.Append("<div class=\"filter\">");
                ...
                result.Append("</div>");
                ViewBag.result = result.ToString();
                ViewBag.nUrl = "<ol itemscope itemtype=\"http://schema.org/BreadcrumbList\">   <li itemprop=\"itemListElement\" itemscope  itemtype=\"http://schema.org/ListItem\"> <a itemprop=\"item\" href=\"http://Bontana.vn\">  <span itemprop=\"name\">Trang chủ</span></a> <meta itemprop=\"position\" content=\"1\" />  </li>   ›" + name + "</ol> ";
        ...
        public ActionResult search(string tag)
        {
            ...
            ViewBag.Keyword = "<meta name=\"keywords\" content=\"" + tag + "\" /> ";
            ViewBag.canonical = "<link rel=\"canonical\" href=\"http://Bontana.vn/search/" + tag + "\" />";
            string meta = "";
            ...
            result.Append("</div>");
            ViewBag.result = result.ToString();
            ViewBag.nUrl = "<ol itemscope itemtype=\"http://schema.org/BreadcrumbList\">   <li itemprop=\"itemListElement\" itemscope  itemtype=\"http://schema.org/ListItem\"> <a itemprop=\"item\" href=\"http://Bontana.vn\">  <span itemprop=\"name\">Trang chủ</span></a> <meta itemprop=\"position\" content=\"1\" />  </li>   ›Bạn đang tìm kiếm : " + tag + "</ol> ";
